...
public final class Constants {
	...
	public static class SwerveConstants {
		...
		public static final double SLOW_SPEED = 0.3;// .5
		public static final double REGULAR_SPEED = 0.60;// .8
		public static final double FAST_SPEED = .80;// 1.0
	}
	...
	public static class VisionConstants {
		...
		public static final Transform3d SHOOTER_CAMERA_POSITION = new Transform3d(-Units.inchesToMeters(14.0 + 3.0 / 4.0), Units.inchesToMeters(0.0), Units.inchesToMeters(6.0 + 7.0 / 16.0), new Rotation3d(0, Units.degreesToRadians(64.0), Units.degreesToRadians(180.0)));
	}
}